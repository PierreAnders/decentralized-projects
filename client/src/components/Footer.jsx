  ...
  <div className="w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer">
    <div className="w-full flex sm:flex-row flex-col justify-between items-center my-4">
      ...
      <a href="https://discord.com/" className="text-white text-base text-center mx-2 cursor-pointer">Discord</a>
        ...
        <a href="https://ens.domains/fr/" className="text-white text-base text-center mx-2 cursor-pointer">ENS</a>
      </div>
    </div>

    <div className="flex justify-center items-center flex-col mt-5">
      <p className="text-white text-sm text-center">Submit a decentralized project to the community at:</p>
      <p className="text-white text-sm text-center font-medium mt-2">ethereum@decentralized-projects.com</p>
    </div>
